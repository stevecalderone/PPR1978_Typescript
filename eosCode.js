...
;
var gasLawR = 0.000083144621;
var currentNumberOfGroups = 31;
/***********************************************************************************************/
...
function calculate_T_BubDew_Est(dataRange, pressure, moles, dewOrBub, errMsgsOn, passedDataSet, passedMoleComp, passedPressure) {
    ...
    try {
        ...
        var T_Bub_Est = 0;
        var Counter = 0;
        var T_Bub_RoughEst_Temp = 0;
        var T_Dew_RoughEst_Temp = 0;
        ...
        var pBara = 0;
        var moleComp = [];
        var binariesUsed = false;
        var errorMsgsOn = false;
        var alpha_aiArray = [];
        var aiArray = [];
        var kij0Array = [];
        var kijTArray = [];
...
function validateData(dataRange, temperature, pressure, moles, inputPhase, binariesUsed, kij0, kijT, decomposition, errorMsgsOn, guessedTemp, CpDataRequired) {
    ...
    try {
        ...
        var pBara = 0;
        var phase = "";
        var outputArray = []; // [[t, p , phase],[dataSet],[moleComp],[kij0],[kijT],[deComp]]
        var sumTest = 0;
